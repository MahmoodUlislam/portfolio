    ...
    <div className={styles.timelineGrid}>
      ...
      <div className={styles.timelineGridItemCard}>
        <div className={styles.cardContent}>
          ...
          <p className={styles.cardContentDescription}>
            Project: LifeLine – Virtual Mental Health Treatment Platform<br />
            <a href="https://virtualhealthhub.ca" target="_blank" rel="noopener noreferrer">https://virtualhealthhub.ca</a><br />
            <a href="https://research-groups.usask.ca/remote-presence" target="_blank" rel="noopener noreferrer">Remote Presence Research</a><br /><br />

            Location: Saskatoon, Saskatchewan, Canada.<br /><br />

            <b>Technologies:</b> JavaScript, React.js, Vue.js, Quasar, React Native (Expo), Node.js, Express.js, REST APIs, PostgreSQL, SASS, CSS<br />
            <b>AWS Services:</b> Amplify, API Gateway, Bedrock, Kinesis, ECS (Fargate), RDS, EventBridge, Chime SDK, Lambda, Step Functions, S3, CloudWatch, Amazon Pinpoint, Cognito<br /><br />

            <b>Key Responsibilities & Contributions:</b><br />
            • Managing the LifeLine project end-to-end, including development, cloud architecture, and AWS infrastructure<br />
            • Developed scalable applications using Vue.js, React.js, Quasar, and React Native for virtual care<br />
            • Built and maintained REST APIs with Node.js/Express and PostgreSQL backend<br />
            • Created custom modules in Swift and Kotlin to integrate Amazon Chime SDK with React Native<br />
            • Bundled Vue and React together using Vite within the same Quasar application<br />
            • Architected AWS infrastructure using Cognito, ECS, API Gateway, and other services for secure, HIPAA-compliant deployments<br />
            • Integrated AWS Bedrock, Kinesis, Transcribe, Rekognition, and HealthLake for AI/ML functionality<br />
            • Designed an appointment booking system, medication reminders, and an AI-powered health chatbot<br />
            • Worked directly with healthcare stakeholders and rural users to iterate based on real-world feedback<br />
          </p>
        </div>
      </div>
      <div className={styles.timelineGridItemAdjoiningCard} />
