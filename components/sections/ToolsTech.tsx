...
const techStack = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: "Swift (iOS)", icon: "/logos/swift-official.png", color: "#FA7343" },
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: "CloudTrail", icon: "/logos/aws-cloudwatch.svg", color: "#FF9900" },
      { name: "AWS Step Functions", icon: "/logos/aws-step-functions.svg", color: "#FF9900" },
      { name: "CloudFormation", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "AWS CDK", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
    ],
  },
  {
    category: "AI & Machine Learning",
    technologies: [
      { name: "Amazon SageMaker AI", icon: "/logos/aws-sagemaker.svg", color: "#FF9900" },
  ...
  },
  {
    ...
    technologies: [
      { name: "AWS Glue", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "Glue DataBrew", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "Amazon Kinesis", icon: "/logos/aws-data-firehose.svg", color: "#FF9900" },
      { name: "Amazon EMR", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "Amazon Athena", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "Amazon Redshift", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "Amazon QuickSight", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "AWS Lake Formation", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
    ],
  },
  {
    ...
    technologies: [
      ...
      { name: "OpenID Connect (OIDC)", icon: "/logos/openid-connect-official.png", color: "#F78C40" },
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: "CodePipeline", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "CodeBuild", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
      { name: "CodeDeploy", icon: "/logos/aws-lambda.svg", color: "#FF9900" },
  ...
  },
  {
    ...
    technologies: [
      { name: "SageMaker Pipelines", icon: "/logos/aws-sagemaker.svg", color: "#FF9900" },
      { name: "Model Monitor", icon: "/logos/aws-sagemaker.svg", color: "#FF9900" },
      { name: "Feature Store", icon: "/logos/aws-sagemaker.svg", color: "#FF9900" },
      { name: "SageMaker Processing", icon: "/logos/aws-sagemaker.svg", color: "#FF9900" },
      { name: "Model Registry", icon: "/logos/aws-sagemaker.svg", color: "#FF9900" },
    ],
  },
]
